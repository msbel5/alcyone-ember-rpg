...
> _Captain atom-map_: authored under `docs/archive/sprint/` as `sprint-faz-4-atom-map.md` when this slice is scheduled (Captain narrow vertical-slice decomposition).
