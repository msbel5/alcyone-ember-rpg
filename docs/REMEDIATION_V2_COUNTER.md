...
| E7-009 | Full 13-scene PlayMode tour | `[E]` | The proof driver (`--ember-scene-tour`) + Unity MCP can produce it; needs a running player/Editor. Recorded as a P1 gate. |
...
| E7-019 | Faction politics (decay) | `[~]` | Deterministic faction-reputation decay is a design-sensitive tick addition — staged with the digest work. |
