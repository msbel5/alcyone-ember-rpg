...
UPDATED : 2026-05-30
```
**Progress: ~28/34 done. Done: P1(9) + P2 dead-code(ARCH-01/03/05/11/12) + hygiene + DOC-01/02/03 + INP-01 + NAME-01/02/03 + LOC-split(SliceSaveMapper 961→6, adapter 829→471=ARCH-02 structural) + SOUL-01/02/03 (living world wired + headless-proven). Also: Codex static audit landed (`docs/CODEX_INDEPENDENT_2026-05-30.md`, §5) + quick-remedies EMB-AUD-001/002/003/005/006/015/016/042/043/044 done. Deleted ~73k lines doc cruft. · ▶ NOW = playability batch (HUD-02/SCN-01/DLG-01) + SOUL-04 view, then black-box play-proof (last). · REMAINING decision/[E]: ARCH-04(save dedup, design-debatable), ARCH-06(`[E]`), ARCH-07(DI, low-ROI), the [E] batch. · prior Codex EMB-001..060 = 60/60**
