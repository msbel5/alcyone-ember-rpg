...
- Current local backend validation on 2026-05-21: `dotnet test tools/validation/fallback/ValidationFallbackHarness.csproj --configuration Release --nologo` passes with 1319 passed, 0 failed, 0 skipped on .NET 8 (was 1306 on 2026-05-21 after the sixth-pass audit; the +13 reflects the seventh-pass regression suite under `Assets/Tests/EditMode/Audit/AuditSeventhPassCoverageTests.cs` plus the Faz 7 vitals round-trip strengthening). Unity editor remains outside this fallback proof.
