...
| 11 | Mami | `Assets/Scenes/Ember/Faz6TradeMarket.unity` | Caravan, prices, faction relations. | `docs/screenshots/faz-6.png` | Mami |
| 12 | Mami | `Assets/Scenes/Ember/Faz7CombatDungeon.unity` | Equip, attack, armor reduction, hostile faction. | `docs/screenshots/faz-7.png` | Mami |
| 13 | Mami | `Assets/Scenes/Ember/Faz8RitualHall.unity` | Fire on oil tile, area damage. | `docs/screenshots/faz-8.png` | Mami |
| 14 | Mami | `Assets/Scenes/Ember/Faz9TavernDialog.unity` | Ask About / Tell Me About surface, NPC refusal on remembered crime. | `docs/screenshots/faz-9.png` | Mami |
| 15 | Mami | `Assets/Scenes/Ember/Faz10OracleShrine.unity` | F9 DM snapshot HUD with memory + faction + ToolCall list. | `docs/screenshots/faz-10.png` | Mami |
