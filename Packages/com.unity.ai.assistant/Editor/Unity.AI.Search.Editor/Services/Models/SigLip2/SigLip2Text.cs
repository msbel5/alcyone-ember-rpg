    ...
    class SigLip2Text : IDisposable
    {
        ...
        void EnsureModelLoaded()
        {
            ...
            if (m_Tokenizer == null)
            {
                ...
                m_Tokenizer = SentencePieceTokenizer.Create(spStream) /* patched: Microsoft.ML.Tokenizers 3.x dropped addBeginOfSentence/addEndOfSentence; defaults remain false so behavior is preserved */;
            }
