# Ember Recovery Final Report — source/pure-C# PASS, runtime DEFERRED
...
| PRD-04 | PASS | Companion follow is persistent; companion guard uses Hunt→StrikeQuarry and canonical cleanup | Companion direct `MoveTo`, direct combat, and duplicate tick systems | Companion gate PASS 57/57 | Final companion gate PASS; built-player story proof DEFERRED |
...
| PRD-07 | PASS | OnWatch remains Running without completion spam; event identity is monotone, bounded and sequence-cursor based | Arrival completion pulses, retained-index cursors and multiple trim owners | Watch/event gate PASS 73/73 | Final event/watch gate PASS; runtime HUD proof DEFERRED |
...
| PRD-09 | PASS | Projection reads only real CurrentAction/events; apply failures are counted/logged; Atlas is repo-relative and fail-closed | `DescribeScheduleWord`, silent apply exceptions, absolute/stale Atlas authority | Projection/movement PASS 40/40; Atlas self-test/check, LFS fsck and strict static audit PASS | Unity PlayMode/build/player visual/JSONL proof DEFERRED |
| PRD-10 | PASS | Exact 1/7/30-day deterministic traces, bounded state/save, through-terminal restore, one movement writer and five coherent stories are pinned | Terminal food/crop loss, unreachable report retries, strike fake progress and digest-blind action roots | Soak PASS 5/5; release gate PASS 32/32; selected final gate PASS 120/120 | Strict static audit PASS; Unity runtime/build/soak proof DEFERRED |
...
- Unity compile/EditMode/PlayMode, Windows build, built-player proof and runtime
  determinism/soak: **DEFERRED** due the documented environment restriction.
...
pure-C# results prove only those lanes; they do not prove Unity or built-player
runtime behavior.
...
- execute Unity/runtime/build/visual/JSONL/soak proof in a capable environment;
...
No push, pull request, or merge is part of this delivery.
