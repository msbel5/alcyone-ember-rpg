...
namespace EmberCrpg.Editor.Ember.Menu
{
    ...
    public static class EmberSceneBuilderMenu
    {
        ...
        public static void RunRecipe(IEmberSceneRecipe recipe)
        {
            ...
            // com.unity.ai.navigation package's NavMeshSurface component. Until
            // that package lands in manifest.json (tracked under the Faz 14
            // navigation sprint), keep the legacy synchronous bake — it still
            // works and produces the same NavMesh.asset. Pragma silences the
            // CS0618 warning so the build stays green.
