...
| Faz 5 slice 8 | PROCESS | Harvest loop | HarvestSystem, acceptance replay | new Simulation/Process harvest system, inventory/stockpile bridge | next |
...
Validate and push Faz 5 slice 7, then wait for #136 GitHub EditMode evidence before adding harvest and acceptance replay.
